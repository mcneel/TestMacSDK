...
public:
  ...
  */
  bool Split(
	...
	/*	 
  Description:
    Remove knots from parameter 0 or parameter 1 knot vector.  Adjust the remaining control points 
		to maintain surface  position as closely as possible.
  Parameters:
		dir - [in] 
      0 or 1.  0 for the first parameter, 1 for the second parameter.
		i0, i1 - [in] ( Order(dir)-2 < i0 < i1 <= CVCount(dir)-1 
			The knots from Knot(dir,i0) through Knot(dir,i1-1) will be removed.
  Returns:
    true if successful.  
		*/
	bool RemoveKnots(
