...
// All McNeel Rhino build version information is in ../version.h
// The McNeel Rhino build process automatically creates ../version.h
// and it specifies all version information in all code used by Rhino.
//
// When opennurbs is released as a public source code library,
// a file named opennurbs_public_version.h is created in the
// folder containing opennurbs.h.
// it is a verbatim copy of the ../version.h file that is current
// at that time.
#include "../version.h"
#else
