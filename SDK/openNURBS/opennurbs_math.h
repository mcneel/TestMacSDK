...
/// <param name="p2"></param>
/// <returns>
/// If the points are valid and not collinear, then the Voronoi area contributionof the 2d triangle is returned.
/// Otherwise 0.0 is returned.
/// </returns>
ON_DECL
double ON_VoronoiArea2d(const ON_2dPoint& p0, const ON_2dPoint& p1, const ON_2dPoint& p2);
...
/// <param name="p2"></param>
/// <returns>
/// If the points are valid and not collinear, then the Voronoi area contribution of the 3d triangle is returned.
/// Otherwise 0.0 is returned.
/// </returns>
ON_DECL
double ON_VoronoiArea3d(const ON_3dPoint& p0, const ON_3dPoint& p1, const ON_3dPoint& p2);
#endif
...
/// The integrand must be C-infinity on each interval (limits[0],limits[1]).
/// </param>
...
/// </param>
/// <param name="limits">
/// limits[] must have at least 2 elements and specifies the
/// limits of integration. 
/// The integrand must be C-infinity on each interval (limits[i],limits[i+1).
/// For example, when integrating over an ON_Curve, pass curve.SpanVector().
/// </param>
/// <param name="relative_tolerance">
/// Desired relative tolerance.
/// If I = mathematical value and N = numerical integration value,
...
/// First parameter passed into the integrand function.
/// </param>
/// <param name="integration_limit">
/// If integration_limit if is not valid (ON_Interval::Nan or ON_Interval::EmptyInterval), 
/// then the integration is performed over the entire domain of the curve. 
/// Otherwise the integration is peformed over the intersection of integration_limit 
/// with each curve span.
/// </param>
/// <param name="relative_tolerance">
/// Desired relative tolerance.
/// If I = mathematical value and N = numerical integration value,
...
/// </param>
/// <param name="limits1">
/// limits of integration for the first integration parameter.
/// The integrand must be C-infinity on domain rectangle limits1 x limits2.
/// </param>
/// <param name="limits2">
/// limits of integration for the second integration parameter.
/// The integrand must be C-infinity on domain rectangle limits1 x limits2.
/// </param>
/// <param name="relative_tolerance">
/// Desired relative tolerance.
...
/// </param>
/// <param name="limits1">
/// limits1[] must have at least 2 elements and specifies the
/// integration limits for the first integration parameter. 
/// On each domain rectangle (limits1[i],limits1[i+1])x(limits2[j],limits2[j+1]), 
/// the integrand must be a C-infinity function.  
/// For example, when integrating over an ON_Surface, 
/// pass surface.SpanVector(0) as limits1 and
/// surface.SpanVector(1) as limits2.
/// </param>
/// <param name="limits2">
/// limits2[] must have at least 2 elements and specifies the
/// integration limits for the second integration parameter. 
/// On each domain rectangle (limits1[i],limits1[i+1])x(limits2[j],limits2[j+1]), 
/// the integrand must be a C-infinity function.  
/// For example, when integrating over an ON_Surface, 
/// pass surface.SpanVector(0) as limits1 and
...
/// Calculates the definite integral of a smooth (C-infinity) 
/// function of two variables using a Rhomberg integration technique
/// and returns returns Integral(f(s,t)*|dS/ds(s,t) x dS/dt(s,t)|*ds*dt),
/// where dS/ds and dS/dt are the surface's first partial derivatives.
/// The C-infinity requirement is used by the Rhomberg algorithm when
/// estimating error bounds and convergence. If you choose to pass a 
/// C2 function, you are likely to converge while getting less accurate
/// results and incorrect error bound estimates.
...
/// and |dS/ds(s,t) x dS/dt(s,t)| is automatically included in the integrand.
/// The integrand must be C-infinity on the intesection each surface bispan 
/// with the interval (limits[0]xlimits[1]).
/// The surface must be 2 or 3 dimensional (surface.Dimension() = 2 or 3).
/// </param>
/// <param name="f">
/// The integrand function is
/// double f(ON__UINT_PTR context, int limit_direction, double t) 
...
/// First parameter passed into the integrand function.
/// </param>
/// <param name="integration_limit1">
/// If integration_limit1 if is not valid (ON_Interval::Nan or ON_Interval::EmptyInterval), 
/// then the integration is performed over the entire domain of the first surface parameter. 
/// Otherwise the integration is peformed over the intersection of integration_limit1 
/// with each surface bispan.
/// </param>
/// <param name="integration_limit2">
/// If integration_limit2 if is not valid (ON_Interval::Nan or ON_Interval::EmptyInterval), 
/// then the integration is performed over the entire domain of the second surface parameter. 
/// Otherwise the integration is peformed over the intersection of integration_limit2 
/// with each surface bispan.
/// </param>
/// <param name="relative_tolerance">
/// Desired relative tolerance.
...
/// <summary>
/// Find a local minimum of the object function f(t[]) of n independent variables.
/// The function must be C2 on the search domain. The search begins at t0[].
/// </summary>
/// <param name="n">
/// n &gt;= 1 and is the number of variables the functiont f().
/// </param>
/// <param name="f">
/// The objective function
/// f(f_context, t, grad) is a function of n independent variables that returns
/// the value of f() at (t[0], t[1], ..., t[n-1]). 
/// Calling f() should return grad = gradient of f at t.
/// If the evaluation cannot be performed, return ON_DBL_QNAN and the seach will
/// terminate.
/// </param>
/// <param name="f_context">
/// The first argument passed to the f() function.
/// </param>
/// <param name="search_domain">
/// If the interval search_domain[i] specifies the interval t[i] is constrained  to be in. 
/// These domains must be finite and set to something reasonable.
/// </param>
/// <param name="t0">
/// t0[] is an input array of n evaluation parameters that specify where the search begins.
/// If t0 is nullptr or t0[i] is not in search_domain[i], then search_domain[i].ParameterAt(0.5)
/// will be used in lieu of t0[i].
/// You are permitted to pass the same array for the input array t0[] and the output array t[],
/// provided it is properly initialized to the paramters where the search should begin.
/// </param>
/// <param name="terminate_value">
...
/// then pass ON_DBL_QNAN.
/// </param>
/// <param name="terminate_gradient">
...
/// provided it is properly initialized to the paramters where the search should begin.
/// </param>
/// <param name="bConverged">
/// If bConverged is not nullptr, then *bConvertged will be true if the search terminated 
/// because of the conditions controlled by terminate_value, relative_tolerance and relative_tolerance.
/// Otherwise *bConverged will be false.
/// </param>
/// <returns>
/// If successful, the local minimum value of f is returned. 
/// Otherwise, ON_DBL_QNAN is returned.
/// </returns>
ON_DECL
double ON_Minimize(
